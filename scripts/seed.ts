...
const FOUNDERS: SeedFounder[] = [
  {
    ...
    bio: "Building the analytics layer for European SaaS teams.",
    isDemo: true,
  ...
  },
  {
    ...
    bio: "Sustainable home goods, shipped across Europe.",
    isDemo: true,
    revenueVisibility: "exact",
  ...
  },
  {
    ...
    bio: "Ops automation for lean remote teams.",
    isDemo: true,
  ...
  },
  {
    ...
    bio: "Brand and product design for ambitious startups.",
    isDemo: true,
    revenueVisibility: "exact",
  ...
  },
  {
    ...
    bio: "Fractional CFO for early-stage founders.",
    isDemo: true,
    revenueVisibility: "range",
  ...
  },
  {
    ...
    category: "saas",
    businessName: "Alto",
    bio: "Building the future of async collaboration.",
    isDemo: true,
    revenueVisibility: "range",
  ...
  },
  {
    ...
    bio: "QA account: verified, growing revenue.",
    isDemo: true,
    revenueVisibility: "exact",
  ...
  },
  {
    ...
    bio: "QA account: verified, revenue decreasing.",
    isDemo: true,
    revenueVisibility: "exact",
  ...
  },
  {
    ...
    bio: "QA account: no revenue source connected.",
    isDemo: true,
