...
const STEPS = ["Account", "Business", "Bio", "Connect"] as const;
    ...
    return (
      <div className="animate-fade-up rounded-lg border border-border bg-card p-8 text-center">
        ...
        <p className="mt-2 text-sm text-text-secondary">
          We sent a confirmation link to <span className="text-text-primary">{account.email}</span>.
      ...
      {step === 0 && (
        <div className="flex flex-col gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">Free during beta. No credit card required.</p>
          </div>
          ...
          <Field label="Username" htmlFor="username" hint="Your public profile: ascend.app/profile/username">
            <Input
              id="username"
